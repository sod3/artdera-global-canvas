...
export const Route = createFileRoute("/creators")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Meet the independent artists, calligraphers and photographers on ArtDera." },
  ...
  return (
    <div className="container-editorial py-14">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-3 font-display text-5xl">Behind every work<br/>is a story.</h1>
        <p className="mt-4 text-muted-foreground">Independent artists, calligraphers, printmakers and photographers — verified and represented on ArtDera.</p>
      </div>
        ...
        {CREATORS.map((c) => (
          <Link key={c.slug} to="/creator/$slug" params={{ slug: c.slug }} className="group block">
            <div className="relative aspect-[4/5] overflow-hidden rounded-lg">
              ...
              {c.verified && <span className="absolute top-3 left-3 chip" style={{ background: "var(--porcelain)", color: "var(--ink)" }}>✓ Verified</span>}
            </div>
            <div className="mt-4">
