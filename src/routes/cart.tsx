      ...
      <div className="mt-10 grid lg:grid-cols-[1.5fr_1fr] gap-10">
        <div>
          {items.map((p) => (
            ...
            >
              <div className="w-28 h-32 overflow-hidden rounded flex-shrink-0">
        ...
        <aside
          className="rounded-xl p-6 border h-fit lg:sticky lg:top-24"
          style={{ background: "var(--porcelain)", borderColor: "var(--color-border)" }}
        >
          ...
          <div
            className="mt-4 pt-4 border-t flex justify-between font-semibold text-lg"
            style={{ borderColor: "var(--color-border)" }}
          >
            <span>Total</span>
